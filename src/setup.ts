...
export const setup = () => {
    ...
    const handleOrientation = (event: DeviceOrientationEvent)=>{
        ...
        htmlPerso.style.top = formatPosition(y, 0.05);
        htmlPerso.style.left = formatPosition(x, 0.05);
        htmlFg.style.top = formatPosition(y, 0.07);
        htmlFg.style.left = formatPosition(x, 0.07);
